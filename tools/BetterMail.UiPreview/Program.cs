...
internal static partial class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        {
            try { if (args.Contains("--busy")) await CaptureBusyAsync(output); else if (args.Contains("--workspaces")) await CaptureWorkspaceFixesAsync(output); else if (args.Contains("--search")) await CaptureSearchAsync(output); else await CaptureAsync(output); }
