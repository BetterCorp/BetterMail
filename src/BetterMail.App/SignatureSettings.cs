...
public static class SignatureCatalog
{
    ...
    [
        new("blank", "Blank", "Start from scratch", "#157EFB", ""),
        new("minimal", "Minimal", "Clean name and contact details", "#157EFB", """
            ...
            """),
        new("professional", "Professional", "A polished business signature", "#0F6CBD", """
            ...
            """),
        new("compact", "Compact", "Small enough for busy threads", "#008C7A", """
            ...
            """),
        new("executive", "Executive", "Strong hierarchy and restrained detail", "#040F2F", """
            ...
            """),
        new("modern", "Modern", "Bold accent with simple details", "#615FFF", """
            ...
            """),
        new("corporate", "Corporate", "Structured company contact block", "#1F4E79", """
            ...
            """),
        new("support", "Customer Support", "Friendly support-team identity", "#008C7A", """
            ...
            """),
        new("sales", "Sales", "Contact details with a clear next step", "#D66A1F", """
            ...
            """),
        new("personal", "Personal", "Warm and informal", "#C84B71", """
            ...
            """),
        new("legal", "Legal / Disclaimer", "Contact block with disclaimer space", "#666666", """
            ...
            """),
        new("social", "Social Links", "Contact details and social profiles", "#0A66C2", """
            ...
            """),
        new("logo", "Logo and Contact", "Designed for a company logo", "#157EFB", """
