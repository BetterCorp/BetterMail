...
internal sealed partial class McpMailTools
{
    ...
    private static readonly object CapabilityUsage = new
    {
        ...
        mailSources = "Use read_mail_headers for internet headers, read_mail_raw for base64 chunks of original MIME, and get_mail_link for stable message references. HTTP links select the active tunnel or local MCP endpoint and require the MCP bearer header. localUrl opens the installed BetterMail app. Raw downloads require provider connectivity.",
